...
AES::AES(unsigned char* key0)
{
    for(int i = 0; i < 16; i++)
        key[i] = key0[i];
}

unsigned char* AES::encrypt(unsigned char* plaintext)
{
...
unsigned char* AES::decrypt(unsigned char* ciphertext)
{
    unsigned char state[4][4];
    for(int i = 0; i < 4; i++)
        for(int j = 0; j < 4; j++)
...
void AES::ByteSub(unsigned char state[][4])
{
    for(int i = 0; i < 4; i++)
        for(int j = 0; j < 4; j++)
...
void AES::MixColumn(unsigned char state[][4])
{
    unsigned char t[4];
    for(int i = 0; i < 4; i++)
    {
...
void AES::InvByteSub(unsigned char state[][4])
{
    for(int i = 0; i < 4; i++)
        for(int j = 0; j < 4; j++)
